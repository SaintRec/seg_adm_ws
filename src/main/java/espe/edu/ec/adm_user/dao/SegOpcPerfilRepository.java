...
public interface SegOpcPerfilRepository extends CrudRepository<SegOpcPerfil, Long> {
 ...
 SegOpcPerfil findByoppId(Long oppId);

 List<SegOpcPerfil> findAllByopcId(Long opcId);

 List<SegOpcPerfil> findAllByperId(Long perId);

 void deleteByopcId(Long opcId);
